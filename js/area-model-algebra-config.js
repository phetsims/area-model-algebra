 ...
 * please modify area-model-algebra/package.json to control dependencies.
 *
 * RequireJS configuration file for the area-model-algebra sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'area-model-algebra-main' ],
